...
from chameleon.legacy.skfeature.utility.sparse_learning import generate_diagonal_matrix
from chameleon.legacy.skfeature.utility.sparse_learning import calculate_l21_norm
